...
import random
import torch
from model.trainer import create_ARGAN_3d_trainer_with_spectrum,create_ARGAN_3d_trainer_without_spectrum
import os
...
def main():
    ...
    # create trainer
    trainer = create_ARGAN_3d_trainer_without_spectrum(config)
